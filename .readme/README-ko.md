...
Settings 플러그인은 선택한 KGP를 루트 프로젝트의 buildscript classpath에 자동으로 추가합니다. AGP 9 내장 Kotlin을 사용할 때는 `org.jetbrains.kotlin.android`를 함께 적용하지 마세요. 결정 결과는 `gradle.extra["platformVersions"]`를 통해 객체 형태로 읽을 수 있습니다.
