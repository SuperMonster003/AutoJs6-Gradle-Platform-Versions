...
* `Исправление` Пропускать проверку версии выпуска при отсутствии изменений данных платформы в запланированных запусках и не устанавливать устаревший пакет Android SDK tools в CI
* `Улучшение` Оба примера потребителей переведены на compileSdk / targetSdk 37, обновлены необходимые версии Gradle и AGP, а отрицательный тест выравнивания нативных библиотек и CI адаптированы к Android SDK 37
...
* `Функция` Общий плагин Gradle nativeAlignment проверяет выравнивание ELF и ZIP в APK на 16 KB, анализирует нативные архивы и отклоняет несовместимые или отсутствующие артефакты до распространения
* `Улучшение` Подготовка Android SDK перед запуском отрицательного примера проверки нативного выравнивания в CI
