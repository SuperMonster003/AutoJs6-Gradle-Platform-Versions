...
* `Исправление` AGP 9.1 читает SDK repository XML v4 с помощью sdklib 32.2.1, сохраняя выбранные версии AGP и AAPT2
* `Исправление` Проверка выравнивания нативных библиотек исключает задачи сборки модульных тестов JVM и тестовых фикстур, которые не создают APK
