...
入口按迁移前的职责边界依次运行 9 个独立任务: Gradle/Kotlin、Kotlin/R8、Android Studio 发行版、Android Studio/AGP、Java/Gradle、AGP/Gradle、AGP 发行版、KSP 发行版与 KSP/AGP. 一个来源或数据集解析失败时会被精确定位到对应任务, 不再由 4 个聚合任务掩盖失败范围.
